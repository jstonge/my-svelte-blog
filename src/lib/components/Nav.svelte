<script lang="ts">
  ...
  let { variant = 'centered' }: { variant?: 'centered' | 'left' } = $props();
...
<header class="header" class:header-left-aligned={variant === 'left'}>
  <div class="header-inner">
    ...
    {:else}
      <a href="{base}/" class="title-link">
        <img src="/jso-left-aligned.svg" alt="jso.cool" class="site-logo-small site-logo-light" />
        <img src="/jso-left-aligned-dark.svg" alt="jso.cool" class="site-logo-small site-logo-dark" />
      </a>
    {/if}
    ...
    <div class="header-right">
      ...
      <a href="https://github.com/jstonge/my-svelte-blog" target="_blank" rel="noopener noreferrer" class="github-button icon-button" aria-label="View on GitHub">
...
<style>
  ...
  .header-left-aligned .header-inner {
